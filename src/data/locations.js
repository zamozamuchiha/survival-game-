...
/**
 * No zombies anywhere, for now.
 *
 * Turned off deliberately rather than by emptying every location's mix, so the
 * tuning below survives and switching them back on is this one line. While it is
 * true the world is empty of anything hostile: good for building and looking at
 * the place, and it makes the first mission chain's kill goal unreachable — see
 * the note in data/missions.js.
 */
export const PEACEFUL = true;
